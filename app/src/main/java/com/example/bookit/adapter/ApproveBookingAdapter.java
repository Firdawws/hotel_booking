...
public class ApproveBookingAdapter  extends RecyclerView.Adapter<ApproveBookingAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ApproveBookingAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.edPrice.setText(new StringBuilder().append("Price: ").append(String.valueOf(price)).append(" KSH").toString());
        holder.edTotal.setText(new StringBuilder().append("Total: ").append(String.valueOf(totalPayment)).append(" KSH").toString());
        //set the image
