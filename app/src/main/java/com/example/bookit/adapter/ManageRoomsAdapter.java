...
import com.example.bookit.activity.AddRoomActivity;
    ...
    public void onBindViewHolder(@NonNull ManageRoomsAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                DocumentReference record = firebaseFirestore.collection("HotelData").document(id);
                record.delete().addOnSuccessListener(new OnSuccessListener< Void >() {
                    @Override
                    public void onSuccess(Void aVoid) {

                        Toast.makeText(v.getContext(), "Hotel Deleted", Toast.LENGTH_LONG).show();
                        //delete from the ui
                ...
                if(!TextUtils.isEmpty(title)
                    ...
                    record.update("title",title, "description",description,
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Toast.makeText(view.getContext(), "Hotel Updated", Toast.LENGTH_LONG).show();
